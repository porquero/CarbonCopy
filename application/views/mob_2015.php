...
<html>
    <head>
        ...
        . link_tag('pub/mob_2015/css/main.css')
        . @$head . @$_head;
        ?>
...
<?php endif; ?>
        ...
        <div id="aggressive_message"><div><span><?php echo @isset($aggressive_message) ? $aggressive_message : lang('wait_please'); ?></span> <img src="<?php echo base_url('pub/mob_2015/img/ajax-loader.gif') ?>" alt="" /></div></div>
        <ul id="shortcuts"></ul>
        <?php
        echo
        js_tag('pub/js/jquery-1.9.1.js')
        . js_tag('pub/js/main.js')
        . js_tag('pub/mob_2015/js/main.js')
